                ...
                <div class="mx-auto max-w-screen-xl">
                    <form action="#" method="POST" enctype="multipart/form-data">
                        <div class="grid gap-4 mb-4 sm:grid-cols-2">
                            ...
                            <div class="col-span-2">
                                ...
                                <input name="image" required
                                    class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 p-[7px] dark:border-gray-600 dark:placeholder-gray-400"
                                    aria-describedby="image_help" id="image" type="file" />
                                <p class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="image_help">
                                    Recommend Size 1x1 (MAX:
                                    2MB).
                                </p>
                            </div>
                        ...
                        <div class="flex justify-end gap-2">
                            <a href="index.html"
                                class="px-8 py-2 border-2 border-black hover:bg-black text-black hover:text-white">Back</a>
                            <button
                                class="px-8 py-2 bg-black hover:bg-white hover:text-black border-2 border-black text-white">
                                Add Product
                            </button>
                        </div>
                    </form>
